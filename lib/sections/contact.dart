...
class _ContactState extends State<Contact> {
  ...
  void initState() {
    super.initState();
    content.addListener(_updateDir);
  }

  @override
  void dispose() {
    content.removeListener(_updateDir);
    content.dispose();
    super.dispose();
  }

  void _updateDir() {
    final newDir = _detectDirection(content.text);
    if (newDir != _dir) setState(() => _dir = newDir);
  }

  TextDirection _detectDirection(String s) {
  ...
  Widget _buildForm(double width) {
    return MouseRegion(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          hintText: "Write your message / اكتب رسالتك",
        ...
        validator: (v) => (v == null || v.isEmpty)
            ? "Please enter your message / من فضلك اكتب رسالتك"
            : null,
      ),
    ),
